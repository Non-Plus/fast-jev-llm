...
import { parseClaudeJsonl } from "./parser.js";
import type {
...
function previewOptions(options?: AnalyzeClaudeSessionOptions): {
...
export function toShadowResult(
  ...
  options?: AnalyzeClaudeSessionOptions,
): ShadowAnalysisResult {
  ...
  return {
    ...
    ...(parsed.meta.claudeVersion !== undefined ? { claudeVersion: parsed.meta.claudeVersion } : {}),
...
export function toShadowJsonDocument(
  ...
  return {
    metadata: {
      ...
      ...(result.claudeVersion !== undefined ? { claudeVersion: result.claudeVersion } : {}),
...
/**
 * Observe a Claude transcript and run the provider-independent engine against
