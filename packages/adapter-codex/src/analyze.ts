...
function previewOptions(options?: AnalyzeCodexSessionOptions): {
...
export function toShadowResult(
  ...
  options?: AnalyzeCodexSessionOptions,
): ShadowAnalysisResult {
...
/**
 * Observe a Codex transcript and run the provider-independent engine against
...
export function cloneForImmutabilityCheck(value: unknown): string {
